                    ...
                    <div className="col-12 col-lg-6 m-auto">
                        <div className="row mt-4 my-md-auto">
                            <div className="col-sm-10 col-xl-8 m-auto">
                                ...
                                <p className="lead mb-4">Enter your telephone related to your account</p>
                                {/* Form START */}
                                <form>
                                    {/* telephone */}
                                    <div className="mb-3">
                                    ...
                                    <div className="align-items-center mt-0">
                                        <div className="d-grid">
                                            <button className="btn btn-dark mb-0" type="button">Reset Password</button>
                                        </div>
                                    </div>
                                </form>
                                {/* Sign up link */}
                                <div className="mt-4 text-center">
                                    <span>Already an user? <a href="#" className='fw-bold text-theme'>Login Here</a></span>
                                </div>
                            </div>
                        </div> {/* Row END */}
                    </div>
