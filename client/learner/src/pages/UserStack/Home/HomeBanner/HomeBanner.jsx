...
import man from "../../../../assets/images/element/07.png"
                ...
                <div className="row align-items-center g-5">
                    ...
                    <div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <ul className="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                            <li className="list-inline-item me-2"> <i className="faf fa-patch-check-fill h6 me-1" />Learn with experts</li>
                            <li className="list-inline-item me-2"> <i className="faf fa-patch-check-fill h6 me-1" />Get certificate</li>
                            <li className="list-inline-item"> <i className="faf fa-patch-check-fill h6 me-1" />Get membership</li>
                        </ul>
                        <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            {/* Button */}
                            <a href="#" className="btn btn-lg fs-2 fw-bolder bg-theme text-theme me-2 mb-4 mb-sm-0 rounded-4">Get Started</a>
                        ...
                        <div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style={{ background: 'url(assets/images/pattern/01.png) no-repeat center center', backgroundSize: 'cover' }}>
                            ...
                            <ul className="avatar-group mb-0">
                                <li className="avatar avatar-sm">
                                    <img className="avatar-img rounded-circle border-white" src={img01} alt="avatar" />
                                </li>
                                <li className="avatar avatar-sm">
                                    <img className="avatar-img rounded-circle border-white" src={img02} alt="avatar" />
                                </li>
                                <li className="avatar avatar-sm">
                                    <img className="avatar-img rounded-circle border-white" src={img02} alt="avatar" />
                                </li>
