                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="input-group input-group-lg">
                                            ...
                                            type="email" 
                                            name='email'
                                            className="form-control border-0 bg-light rounded-end ps-1" placeholder="E-mail" id="exampleInputEmail1" />
                                        </div>
                                    </div>
                                    {/* Password */}
                                    <div className="mb-0">
                                        ...
                                        <div className="input-group input-group-lg">
                                            ...
                                            type="password" 
                                            name='password'
                                            className="form-control border-0 bg-light rounded-end ps-1" placeholder="password" id="inputPassword5" />
                                        </div>
                                    </div>
                                    {/* Check box */}
