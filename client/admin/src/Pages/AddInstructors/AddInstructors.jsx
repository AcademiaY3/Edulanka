      ...
      <div className="container">
        <div className="row">
          <div className="col-12 text-center">
            {/* Title */}
            <h1 className="text-white">Add a New Instructor</h1>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8 mx-auto text-center">
            {/* Content */}
            <p className="text-center">Use this interface to add a new Instructor to the portal. Once you are done adding the item it will be reviewed and you will be informed.</p>
          </div>
        </div>
        </div>
        </section>
                    ...
                    <form>
                        <div className="row row-gap-4">
                            <div className="col-md-6">
                                ...
                                <label htmlFor="photo-upload" className="form-label">Profile Photo:</label>
                            </div>
                            <div className="col-md-6">
                            ...
                            <div className="col-md-6">
                                <input type="text" className="form-control" placeholder="Mobile Number" aria-label="Mobile Number" required />
                            </div>
                            <div className="col-md-6">
                                <input type="email" className="form-control" placeholder="Email Address" aria-label="Email Address" required />
                            </div>
                            <div className="col-md-6">
                                <input type="text" className="form-control" placeholder="Education" aria-label="Education" required />
                            </div>
                            <div className="col-md-6">
                                <input type="text" className="form-control" placeholder="Description" aria-label="Description" required />
                            </div>
                            <div className="col-md-6">
                                <input type="date" className="form-control" placeholder="Joined Date" aria-label="Joined Date" required />
                            </div>
