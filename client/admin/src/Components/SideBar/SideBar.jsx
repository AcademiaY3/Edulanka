                        ...
                        <ul className="navbar-nav flex-column" id="navbar-sidebar">
                            ...
                            <li className="nav-item">
                                <NavLink to={'/main/courses'} className="nav-link" role="button" aria-expanded="true" >
                                    <i className="fas fa-book fa-fw me-2" />Courses
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link" to={'/main/learners'}><i className="fas fa-user-graduate fa-fw me-2" />Learners</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink to={'/main/instructors'} className="nav-link" role="button" aria-expanded="true" >
                                    <i className="fas fa-chalkboard-user fa-fw me-2" />Instructors
                                </NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link" to={'/main/staff'}><i className="fas fa-user-cog fa-fw me-2" />Staff</NavLink>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link" to={'/main/approvals'}><i className="far fa-address-book fa-fw me-2" />Approvals</NavLink>
                            </li>
                        </ul>
